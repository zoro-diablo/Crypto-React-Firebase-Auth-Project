        ...
        <div
          className={
            theme === 'dark'
              ...
              : ' border-2 card m-auto text-accent w-full sm:w-[clamp(1120px,80%,150px)] hover:brightness-90 transition-all group bg-gradient-to-tl from-gray-200 to-white hover:from-slate-100 hover:to-white border-r-2 border-t-2 border-gray-200 rounded-lg overflow-hidden'
          }
        >
